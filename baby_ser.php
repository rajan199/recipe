	...
	<div class="container">
			...
			<div class="wrap-in">
				...
				<?php
				 ...
				 $x1=@$_SESSION["sermain2"];
	$con=mysql_connect('localhost','root','');
    mysql_select_db('medicine',$con);
     
 $res1=mysql_query("select * from product_tbl where category_id='9' and product_name like '$x1%'",$con);
...
$cnt1=mysql_query("select * from product_tbl where category_id='9' and product_name like '$x1%' ",$con);
